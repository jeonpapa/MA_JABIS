...
주요 필드: `subscription_id, owner_email, recipients[], keywords[], companies[], brands[], aliases{}, disease_areas[], policy_topics[], media[], personas[], lookback_hours, delivery_mode`.
